...
def generate_launch_description():
    ...
    param_substitutions = {
        ...
        'behavior_server.ros__parameters.global_frame': [LaunchConfiguration('namespace'), '/map'],
        'behavior_server.ros__parameters.local_frame': [LaunchConfiguration('namespace'), '/odom'],
