 ...
 * ROS 2: Follow the official instructions [here](https://docs.ros.org/en/jazzy/Installation.html) to install **ROS 2 Jazzy** to your system. Use the **desktop-full** variant, which includes the Gazebo simulator.
